...
- Read Guttman, N.B., 1999. Accepting the Standardized Precipitation Index: A calculation algorithm. Journal of the American Water Resources Association, 35(2), 311-322.
...
- `MASS::fitdistr(x, densfun)` fits data to distributions with maximum liklihood and returns coefficients of a function (shape and rate) with standard errors
