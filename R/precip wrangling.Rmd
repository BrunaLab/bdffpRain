...
This shows any problems with dates by checking the data against a sequence from earliest to latest date by day. Site 41dia is missing one day, and site CABO has many missing dates, probably due to an entry error somewhere.
...
anti_join(tester, all, by = c("site" = "site", "date" = "data"))
```
